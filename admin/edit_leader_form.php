...
?>
<div class="row-fluid">
       <a href="leader.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Leader</a>
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Leader</div>
                            </div>
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								if($fileName){
                                    mysqli_query($conn,"update leaders set name = '$name' , description = '$description' , image = '$fileName' where id = '$get_id' ")or die(mysqli_error());	
                                } else{
                                    mysqli_query($conn,"update leaders set name = '$name' , description = '$description'  where id = '$get_id' ")or die(mysqli_error());	
                                }
